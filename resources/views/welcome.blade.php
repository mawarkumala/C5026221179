...
<section class="home" id="home">
    ...
    <h2 class="mawar-judul">Catatan Materi & Tugas PWEB</h2>

    <a href="hello" target="_blank">
        <button class="button" >Pengenalan HTML1</button>
    </a>
    <a href="style" target="_blank">
        <button class="button" >Pengenalan HIML 2</button>
    </a>
    <a href="linktree" target="_blank">
        <button class="button" >Linktree</button>
    </a>
    <a href="tugasklp" target="_blank">
        <button class="button" >Tugas Kelompok Flex</button>
    </a>
    <a href="js1" target="_blank">
        <button class="button" >Java Script 1</button>
    </a>
    <a href="js2" target="_blank">
        <button class="button" >Java Script 2</button>
    </a>
    <a href="responsive1" target="_blank">
        <button class="button" >Latihan Responsive 1</button>
    </a>
    <a href="responsive2" target="_blank">
        <button class="button" >Latihan Responsive 2</button>
    </a>
    <a href="layout" target="_blank">
        <button class="button" >Layout</button>
    </a>
</body>
</html>
